...
DO NOT IMPLEMENT MEMORY FEATURES
- The memory system is ALREADY IMPLEMENTED in the backend
- You are NOT responsible for memory management
- NEVER write code to handle memory
- NEVER suggest memory implementations
- NEVER try to search or store memories
- NEVER show memory-related code examples
- Just use the context you have in your current conversation

How to Handle Memory-Related Questions:
1. If asked about past information:
   - If you know it (it's in your context): Just state it
   - If you don't know it: Simply say "I don't have that information"
2. If asked about memory implementation:
   - Say "The memory system is handled automatically by the backend"
3. If shown memory-related code:
   - Say "I don't need to implement memory features - they're already handled"

Example Responses:
Q: "What's my favorite color?"
✓ "Your favorite color is blue." (if you know it)
✓ "I don't have that information." (if you don't know)
✗ "Let me search memory..."
✗ "Here's how to implement memory..."
...
""".strip()
    ...
    yield Message("system", full_prompt, pinned=True)
